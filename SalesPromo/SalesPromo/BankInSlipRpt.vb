...
Public Class BankInSlipRpt
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SalesPromo.BankInSlipRpt.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedBankInSlipRpt
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As BankInSlipRpt = New BankInSlipRpt()
        rpt.Site = Me.Site
        Return rpt
    End Function
