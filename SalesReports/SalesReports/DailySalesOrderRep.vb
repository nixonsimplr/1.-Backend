...
Public Class DailySalesOrderRep
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SalesReports.DailySalesOrderRep.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedDailySalesOrderRep
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As DailySalesOrderRep = New DailySalesOrderRep()
        rpt.Site = Me.Site
        Return rpt
    End Function
