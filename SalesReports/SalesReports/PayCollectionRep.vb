...
Public Class PayCollectionRep
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SalesReports.PayCollectionRep.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedPayCollectionRep
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As PayCollectionRep = New PayCollectionRep()
        rpt.Site = Me.Site
        Return rpt
    End Function
