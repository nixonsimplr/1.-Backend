...
Public Class BalanceStockRep
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SalesReports.BalanceStockRep.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedBalanceStockRep
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As BalanceStockRep = New BalanceStockRep()
        rpt.Site = Me.Site
        Return rpt
    End Function
