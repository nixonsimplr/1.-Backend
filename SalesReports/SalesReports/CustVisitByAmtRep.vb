...
Public Class CustVisitByAmtRep
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SalesReports.CustVisitByAmtRep.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCustVisitByAmtRep
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CustVisitByAmtRep = New CustVisitByAmtRep()
        rpt.Site = Me.Site
        Return rpt
    End Function
