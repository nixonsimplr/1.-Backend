...
Public Class StockOrderRep
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SalesReports.StockOrderRep.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedStockOrderRep
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As StockOrderRep = New StockOrderRep()
        rpt.Site = Me.Site
        Return rpt
    End Function
