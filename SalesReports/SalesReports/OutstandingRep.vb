...
Public Class OutstandingRep
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SalesReports.OutstandingRep.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedOutstandingRep
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As OutstandingRep = New OutstandingRep()
        rpt.Site = Me.Site
        Return rpt
    End Function
