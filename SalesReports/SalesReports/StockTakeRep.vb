...
Public Class StockTakeRep
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SalesReports.StockTakeRep.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedStockTakeRep
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As StockTakeRep = New StockTakeRep()
        rpt.Site = Me.Site
        Return rpt
    End Function
