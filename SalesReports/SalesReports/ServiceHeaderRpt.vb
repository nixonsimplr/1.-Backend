...
Public Class ServiceHeaderRpt
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SalesReports.ServiceHeaderRpt.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedServiceHeaderRpt
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As ServiceHeaderRpt = New ServiceHeaderRpt()
        rpt.Site = Me.Site
        Return rpt
    End Function
