...
Public Class MonthlyStatementA
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SalesReports.MonthlyStatementA.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedMonthlyStatementA
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As MonthlyStatementA = New MonthlyStatementA()
        rpt.Site = Me.Site
        Return rpt
    End Function
