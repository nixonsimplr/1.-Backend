...
Public Class CreditNoteRep
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SalesReports.CreditNoteRep.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCreditNoteRep
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CreditNoteRep = New CreditNoteRep()
        rpt.Site = Me.Site
        Return rpt
    End Function
