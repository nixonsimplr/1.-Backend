...
Public Class MissingInvRep
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SalesReports.MissingInvRep.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedMissingInvRep
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As MissingInvRep = New MissingInvRep()
        rpt.Site = Me.Site
        Return rpt
    End Function
