...
Public Class ReturnNoteRep
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SalesReports.ReturnNoteRep.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedReturnNoteRep
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As ReturnNoteRep = New ReturnNoteRep()
        rpt.Site = Me.Site
        Return rpt
    End Function
