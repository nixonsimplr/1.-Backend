...
Public Class ItemCatalogRep
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SalesReports.ItemCatalogRep.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedItemCatalogRep
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As ItemCatalogRep = New ItemCatalogRep()
        rpt.Site = Me.Site
        Return rpt
    End Function
