...
Public Class VoidInvoiceRep
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SalesReports.VoidInvoiceRep.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedVoidInvoiceRep
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As VoidInvoiceRep = New VoidInvoiceRep()
        rpt.Site = Me.Site
        Return rpt
    End Function
