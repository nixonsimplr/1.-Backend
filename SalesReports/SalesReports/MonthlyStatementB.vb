...
Public Class MonthlyStatementB
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SalesReports.MonthlyStatementB.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedMonthlyStatementB
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As MonthlyStatementB = New MonthlyStatementB()
        rpt.Site = Me.Site
        Return rpt
    End Function
