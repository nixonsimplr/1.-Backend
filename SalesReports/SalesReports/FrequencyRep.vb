...
Public Class FrequencyRep
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SalesReports.FrequencyRep.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedFrequencyRep
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As FrequencyRep = New FrequencyRep()
        rpt.Site = Me.Site
        Return rpt
    End Function
