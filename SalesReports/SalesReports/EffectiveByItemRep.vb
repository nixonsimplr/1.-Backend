...
Public Class EffectiveByItemRep
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SalesReports.EffectiveByItemRep.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedEffectiveByItemRep
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As EffectiveByItemRep = New EffectiveByItemRep()
        rpt.Site = Me.Site
        Return rpt
    End Function
