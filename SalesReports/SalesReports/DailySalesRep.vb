...
Public Class DailySalesRep
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SalesReports.DailySalesRep.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedDailySalesRep
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As DailySalesRep = New DailySalesRep()
        rpt.Site = Me.Site
        Return rpt
    End Function
