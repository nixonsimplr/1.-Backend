...
Public Class EffectiveRep
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SalesReports.EffectiveRep.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedEffectiveRep
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As EffectiveRep = New EffectiveRep()
        rpt.Site = Me.Site
        Return rpt
    End Function
