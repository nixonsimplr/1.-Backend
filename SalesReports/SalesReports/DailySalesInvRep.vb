...
Public Class DailySalesInvRep
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SalesReports.DailySalesInvRep.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedDailySalesInvRep
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As DailySalesInvRep = New DailySalesInvRep()
        rpt.Site = Me.Site
        Return rpt
    End Function
