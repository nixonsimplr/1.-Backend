...
Public Class MonthlyStatRpt
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SalesReports.MonthlyStatRpt.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedMonthlyStatRpt
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As MonthlyStatRpt = New MonthlyStatRpt()
        rpt.Site = Me.Site
        Return rpt
    End Function
