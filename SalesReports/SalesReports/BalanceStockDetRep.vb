...
Public Class BalanceStockDetRep
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SalesReports.BalanceStockDetRep.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedBalanceStockDetRep
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As BalanceStockDetRep = New BalanceStockDetRep()
        rpt.Site = Me.Site
        Return rpt
    End Function
