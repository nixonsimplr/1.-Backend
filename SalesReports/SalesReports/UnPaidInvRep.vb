...
Public Class UnPaidInvRep
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SalesReports.UnPaidInvRep.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedUnPaidInvRep
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As UnPaidInvRep = New UnPaidInvRep()
        rpt.Site = Me.Site
        Return rpt
    End Function
