...
Public Class VanInventoryRep
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SalesReports.VanInventoryRep.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedVanInventoryRep
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As VanInventoryRep = New VanInventoryRep()
        rpt.Site = Me.Site
        Return rpt
    End Function
