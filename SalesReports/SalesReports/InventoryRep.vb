...
Public Class InventoryRep
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SalesReports.InventoryRep.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedInventoryRep
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As InventoryRep = New InventoryRep()
        rpt.Site = Me.Site
        Return rpt
    End Function
