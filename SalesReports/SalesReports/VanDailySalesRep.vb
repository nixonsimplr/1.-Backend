...
Public Class VanDailySalesRep
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SalesReports.VanDailySalesRep.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedVanDailySalesRep
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As VanDailySalesRep = New VanDailySalesRep()
        rpt.Site = Me.Site
        Return rpt
    End Function
