...
Public Class rptPostDatedCheque
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SalesReports.rptPostDatedCheque.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptPostDatedCheque
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptPostDatedCheque = New rptPostDatedCheque()
        rpt.Site = Me.Site
        Return rpt
    End Function
