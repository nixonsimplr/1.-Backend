...
Public Class MonthlySalesRep
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SalesReports.MonthlySalesRep.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedMonthlySalesRep
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As MonthlySalesRep = New MonthlySalesRep()
        rpt.Site = Me.Site
        Return rpt
    End Function
