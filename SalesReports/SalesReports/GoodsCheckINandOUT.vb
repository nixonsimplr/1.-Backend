...
Public Class GoodsCheckINandOUT
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SalesReports.GoodsCheckINandOUT.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedGoodsCheckINandOUT
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As GoodsCheckINandOUT = New GoodsCheckINandOUT()
        rpt.Site = Me.Site
        Return rpt
    End Function
